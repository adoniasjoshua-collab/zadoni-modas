...
def home(products):
    return '''<section class="hero launch-hero"><div class="container hero-grid"><div class="hero-copy"><span class="eyebrow">ZAMORE · MODA FEMININA · CANAÃ DOS CARAJÁS</span><h1>Elegância para<br>todos os seus<br><em>momentos.</em></h1><p>Moda feminina elegante, moderna e modesta para vestir seus momentos com personalidade.</p><a class="button" href="#colecao">Escolha sua peça →</a></div><div class="launch-photo editorial-card"><img src="./assets/img/serena.jpg" alt="Vestido longo oliva da seleção de fotos fornecidas à ZAMORE" width="1086" height="1448" fetchpriority="high"></div></div></section>''' + catalog(products) + '''<section id="como-comprar" class="how-to-buy"><div class="container"><span class="eyebrow">SIMPLES, DO SEU JEITO</span><h2>Da escolha à conversa</h2><ol><li><span>01</span><h3>Escolha a peça</h3><p>Abra os detalhes do look que você gostou.</p></li><li><span>02</span><h3>Confira tamanho e cor</h3><p>Veja as opções e consulte o guia de medidas.</p></li><li><span>03</span><h3>Converse no WhatsApp</h3><p>Consulte disponibilidade e condições com a equipe.</p></li></ol><p class="collection-note">O atendimento será ativado quando o WhatsApp oficial estiver configurado.</p></div></section>'''

def footer(base):
    return f'''<footer><div class="container"><div class="launch-footer"><div><a class="logo" href="{base}">ZAMORE<small>MODA FEMININA</small></a><p>Moda feminina elegante, moderna e modesta.<br>Canaã dos Carajás · PA.</p></div><nav aria-label="Ajuda e informações"><a href="{base}sobre/">Sobre a ZAMORE</a><a href="{base}guia-de-tamanhos/">Guia de tamanhos</a><a href="{base}trocas-e-devolucoes/">Trocas e devoluções</a><a href="{base}contato/">Atendimento</a></nav><div><p>Quer saber o valor de uma peça?</p><button class="button secondary" data-whatsapp>Falar no WhatsApp ↗</button></div></div><div class="footer-bottom">© 2026 ZAMORE · Moda Feminina · Consulte valores e disponibilidade pelo WhatsApp.</div></div></footer>'''
